...
const PackageSelector = ({ packages, selectedPackage, onPackageSelect, quantity, onQuantityChange, loading = false }) => {
  return (
    <div>
      ...
      {loading ? (
        <div className="text-center py-8">
          <div className="text-gray-600">Đang tải gói nạp...</div>
        </div>
      ) : (
